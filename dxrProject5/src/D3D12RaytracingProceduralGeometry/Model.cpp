...
D3D12_RAYTRACING_GEOMETRY_DESC& ModelLoading::Model::GetGeomDesc()
{
...
D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC& ModelLoading::Model::GetBottomLevelBuildDesc()
{
...
D3D12_RAYTRACING_ACCELERATION_STRUCTURE_PREBUILD_INFO& ModelLoading::Model::GetPreBuild(bool is_fallback, ComPtr<ID3D12RaytracingFallbackDevice> m_fallbackDevice, ComPtr<ID3D12Device5> m_dxrDevice)
{
...
ComPtr<ID3D12Resource> ModelLoading::Model::GetBottomLevelScratchAS(bool is_fallback, ComPtr<ID3D12Device> device, ComPtr<ID3D12RaytracingFallbackDevice> m_fallbackDevice, ComPtr<ID3D12Device5> m_dxrDevice)
{
...
ComPtr<ID3D12Resource> ModelLoading::Model::GetBottomAS(bool is_fallback, ComPtr<ID3D12Device> device, ComPtr<ID3D12RaytracingFallbackDevice> m_fallbackDevice, ComPtr<ID3D12Device5> m_dxrDevice)
{
...
WRAPPED_GPU_POINTER ModelLoading::Model::GetFallBackWrappedPoint(D3D12RaytracingSimpleLighting* programState, bool is_fallback, ComPtr<ID3D12RaytracingFallbackDevice> m_fallbackDevice, ComPtr<ID3D12Device5> m_dxrDevice, UINT numBufferElements)
{
...
void ModelLoading::Model::FinalizeAS()
{
